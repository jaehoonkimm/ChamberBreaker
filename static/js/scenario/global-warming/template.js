...
export const contentHTML = [
  ...
  `<div>
        <img src="../static/images/global-warming/effect_L.png" class="fakenews-phone-img"/>
        <p class="fakenews-p">Hold on!<br><br>Some guys are spreading fake news related to Inflation in the community. Due to the echo chamber you made, people are easily fooled by fake news.</p>
    </div>`,
  `<p>WOW!!<br><br>
  ...
  `<img src="../static/images/global-warming/youtube_L.png" class="youtube-img"/>`,
  `<div>
      <img src="../static/images/global-warming/youtube_increase_L.png" class="youtube-increase-img"/><br>
