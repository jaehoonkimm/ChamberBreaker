...
class AntiVaccine {
  ...
  init(num) {
    ...
    sUtils.init('anti-vaccine', tweets, tweetData, retweets, nwTweet);
  ...
  nextScenario = () => {
    ...
    if (num == 0) {
      ...
      this.nextContent();
      sUtils.fadeInElement(`newspaper-img`);
    } else if (num == 18) {
      this.nextContent();
    } else if (num == 19) {
      this.nextContent();
      ...
      badge.updateAntiVaccineScore(this.scenarioScore, this.scenarioNum);
...
const antiVaccine = new AntiVaccine();
export default antiVaccine;
