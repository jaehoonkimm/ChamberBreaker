const guideMessage = [
  ...
  `<p class="explain-p">Great! One more thing before we start the game.<br><br>We will give you one news headline and five related tweets,
    and ask you to evaluate their reliability.<br><br>And this will be done four times.</p>`,
  ...
  `<p class="explain-p">So, where do you begin?<br><br>A total of eight tweets will be presented, and you will be asked to select 
    <span class='highlight'>five</span> of them that either strongly (or weakly) support or criticize a community member’s opinion.</p>`,
